...
use Drupal\shibboleth_path\ShibbolethPathAccess;
// use Drupal\shibboleth\ShibPath\ShibPathAccessChecker;
use Drupal\shibboleth_path\ShibbolethPathAccessInterface;
...
class ShibbolethPathAccessSubscriber implements EventSubscriberInterface {
  ...
  /**
   * @var \Drupal\shibboleth_path\ShibbolethPathAccess
   */
